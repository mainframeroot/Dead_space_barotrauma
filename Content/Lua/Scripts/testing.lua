...
DS.TestingEnabled = false

Hook.Add('chatMessage', 'DS.testing', function(msg, client)
    
    if (msg == 'ds test') then -- a glorified suicide button
    ...
    elseif (msg == 'ds unfuck') then -- a command to remove non-sensical extremity amputations on the head and torso
